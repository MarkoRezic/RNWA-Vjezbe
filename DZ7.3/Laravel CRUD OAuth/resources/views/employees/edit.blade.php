                ...
                <div class="form-group">
                    ...
                    <select id="manager_id" name="manager_id">
                        ...
                        @foreach($managers as $manager)
                            <option value="{{$manager->employee_id}}" {{ $manager->employee_id == $employee->manager_id ? 'selected' : ''}}>{{ $manager->first_name }} {{ $manager->last_name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <select id="department_id" name="department_id">
                        ...
                        @foreach($departments as $department)
                            <option value="{{$department->department_id}}" {{ $department->department_id == $employee->department_id ? 'selected' : ''}}>{{ $department->department_name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
